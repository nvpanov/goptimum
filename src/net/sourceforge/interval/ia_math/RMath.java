...
/*
    	  //nvp
//    	 double tmp = exp_hi(mul_hi(y,log_lo(x)));
    	 double o1 = Math.log(x);
    	 double h1 = log_lo(x);
    	 double l1 = log_hi(x);
    	 
    	 double o2 = y*o1;
    	 double h2 = mul_hi(y,h1);
    	 double l2 = mul_lo(y,l1);
    	 
    	 double o3 = Math.exp(o2);
    	 double h3 = exp_hi(h2);
    	 double l3 = exp_lo(l2);
...
*/
         //return  exp_lo(mul_lo(y,log_hi(x)));
    	  return  exp_lo(mul_lo(y,log_lo(x))); //nvp!!!
      }
    } 
    else if (y == 0) 
        return 1.0;
...
//        return  exp_hi(mul_hi(y,log_lo(x)));
          return  exp_hi(mul_hi(y,log_hi(x))); //nvp!!
      }
    } 
    else if (y == 0) 
        return 1.0;
